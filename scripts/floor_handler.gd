...
@onready var floor_meshes = [preload("res://models/chip_2.obj"), preload("res://models/chip_4.obj"), preload("res://models/chip_5.obj")]
@onready var floor_uvs = [preload("res://materials/chip_2.tres"), preload("res://materials/chip_4.tres"), preload("res://materials/chip_5.tres")]
@onready var floor_colliders = [preload("res://models/colliders/chip_2_collider.tres"), preload("res://models/colliders/chip_4_collider.tres"), preload("res://models/colliders/chip_5_collider.tres")]
...
#@onready var floor_colliders = [preload("res://models/colliders/chip_1_collider.tres"), preload("res://models/colliders/chip_2_collider.tres"), preload("res://models/colliders/chip_3_collider.tres"), preload("res://models/colliders/chip_4_collider.tres"), preload("res://models/colliders/chip_5_collider.tres")]
...
func create_floor():
	...
	new_floor.get_child(0).get_child(0).set_shape(floor_colliders[floor_n])
